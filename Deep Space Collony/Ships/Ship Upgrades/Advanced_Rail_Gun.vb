Public Class Advanced_Rail_Gun
    Inherits upgradeBase

    Public Sub New()
        Stats(ship.Ship_Stats.Damage) = 10
        Name = "Advanced Rail Gun"
        Description = "By increasing the current flowing through the rails of our frigates main guns we the scientists say we can increase the impact force of our shots." + Environment.NewLine +
